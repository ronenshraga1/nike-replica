...
function Header() {
  return (
    <nav className={styles.header}>
        ...
        <div>
            <Link href="/products"  className={styles.link}>New & Featured</Link>
            <Link href="/products" className={styles.link}>Men</Link>
            <Link href="/products" className={styles.link}>Women</Link>
            <Link href="/products" className={styles.link}>Sale</Link>
        </div>
